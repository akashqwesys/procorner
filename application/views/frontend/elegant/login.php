...
<aside>
  ...
  <div class="text-center add_top_10 mt-3"><?php echo site_phrase('new_to').' <strong>'.get_settings('system_name').'</strong>'; ?>? <strong><a href="<?php echo site_url('home/sign_up'); ?>"><?php echo site_phrase('sign_up'); ?>!</a></strong></div>
