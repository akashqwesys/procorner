                    ...
                    <div class="course-box-wrap">
                        <div class="course-box">
                            <div class="course-image">
                                <a href="<?php echo site_url(rawurlencode(slugify($my_course['title']))); ?>"><img src="<?php echo $this->crud_model->get_course_thumbnail_url($my_course['id']); ?>" alt="" class="img-fluid"></a>
                                ...
                                <div class="wishlist-add wishlisted">
                                    <button type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="" style="cursor : auto;" onclick="handleWishList(this)" id="<?php echo $my_course['id']; ?>">
