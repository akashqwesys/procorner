        ...
        <!-- <div class="row"> -->
            <!-- <div class="col"> -->
                ...
                <ul class="print-hidden">
                  ...
                  <a href="<?php echo site_url('my-courses'); ?>"><?php echo site_phrase('courses'); ?></a>
                </li>
                  ...
                  <li class="<?php if($page_name == 'user_profile') echo 'active'; ?>"><a href="<?php echo site_url('user-profile'); ?>"><?php echo site_phrase('profile'); ?></a></li>
                </ul>
            </div>
        <!-- </div> -->
    <!-- </div> -->
